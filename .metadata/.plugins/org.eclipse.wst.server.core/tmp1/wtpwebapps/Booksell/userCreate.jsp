...
<option value="99">99</option>
				...
				<tr>
				<td>
				<input type="radio" required="required" name="sex" value="男"> 男性
				<input type="radio" required="required" name="sex" value="女"> 女性
				</td>
				</tr>
				...
				<td>
				<input type="text" required="required" name="streetAddress" value="" />
				</td>
				</tr>
